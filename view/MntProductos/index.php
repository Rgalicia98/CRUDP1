...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href=""><span>[</span>CRUD Equipos De Computo<span>]</span></a></div>
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            ...
            <span class="menu-item-label">Equipos De Computo</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="../MntProductos/" class="nav-link">Mantenimiento Equipo De Computo</a></li>
        </ul>
